...
BOARD_KERNEL_CMDLINE := console=ttyHSL0,115200,n8 androidboot.console=ttyHSL0 androidboot.hardware=qcom msm_rtb.filter=0x237 ehci-hcd.park=3 androidboot.bootdevice=7824900.sdhci lpm_levels.sleep_disabled=1 androidboot.memcg=true earlyprintk firmware_class.path=/vendor/firmware_mnt/image androidboot.selinux=permissive
...
BOARD_SYSTEMIMAGE_PARTITION_SIZE := 1498206208
BOARD_USERDATAIMAGE_PARTITION_SIZE := 5669633536
